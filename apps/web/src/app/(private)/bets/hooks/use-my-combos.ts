...
// Betting selection id for "the match ends in a draw" — mirrors the sentinel in
// packages/match/core (see MATCH_DRAW_SELECTION_ID).
const MATCH_DRAW_SELECTION_ID = 'draw'
