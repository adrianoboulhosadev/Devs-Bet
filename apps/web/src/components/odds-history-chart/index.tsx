...
import { valueAt, type OddsHistorySeries } from '@/lib/odds-history'
...
import {
  ...
  VIEW_WIDTH,
  Y_TICKS,
} from './data/chart-geometry'
import { useOddsHistoryChart } from './hooks/use-odds-history-chart'
...
export function OddsHistoryChart({ snapshots, selectionLabel }: OddsHistoryChartProps) {
  const { svgRef, data, allTimes, hoverT, clearHover, showTable, toggleTable, onMove } =
    useOddsHistoryChart(snapshots)
