...
// and CategoryModule (leaf resolution). The dependency is one-way — MatchModule
// does not import TournamentModule — so there is no module cycle.
@Module({
  imports: [DbModule, AuthModule, QueueModule, CategoryModule, MatchModule],
